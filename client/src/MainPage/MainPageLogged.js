    ...
    render() {
            ...
            // if user doesn't have a team, propose to create one, or to ask invitation
                ...
                teamContent = (
                    <div className="card-body">
                        ...
                        <button className="btn btn-dark mr-3" data-toggle="modal" data-target="#newTeamModal">Create your own</button>
                        <span>or</span>
                        <button className="btn btn-dark ml-3">Ask for invitation</button>
                    </div>
                );
        ...
        return (
            <div className="container">
                ...
                <NewTeamModal id="newTeamModal" loginContext={this.props.loginContext}/>
                <div className="row">
